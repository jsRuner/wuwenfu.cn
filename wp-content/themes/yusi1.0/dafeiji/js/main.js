...
function oddbullet(X,Y){
    bullet.call(this,X,Y,6,14,"http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/bullet1.png");
}
...
function ourplan(X,Y){
    var imagesrc="http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/myplane.gif";
    plan.call(this,1,X,Y,66,80,0,660,0,"http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/myplanebaozha.gif",imagesrc);
...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6,25,274,46,60,5000,360,random(1,3),"http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/middleplanebaozha.gif","http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/enemy3_fly_1.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,210,110,164,30000,540,1,"http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/bigplanebaozha.gif","http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/enemy2_fly_1.png"));
            mark1=0;
        }
        //small飞机
        else{
            enemys.push(new enemy(1,19,286,34,24,1000,360,random(1,4),"http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/smallplanebaozha.gif","http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/enemy1_fly_1.png"));
        }
        mark=0;
    }
            ...
            if(enemys[j].planisdie==false){
                if(enemys[j].imagenode.offsetLeft+enemys[j].plansizeX>=selfplan.imagenode.offsetLeft&&enemys[j].imagenode.offsetLeft<=selfplan.imagenode.offsetLeft+selfplan.plansizeX){
                  if(enemys[j].imagenode.offsetTop+enemys[j].plansizeY>=selfplan.imagenode.offsetTop+40&&enemys[j].imagenode.offsetTop<=selfplan.imagenode.offsetTop-20+selfplan.plansizeY){
                      //碰撞本方飞机，游戏结束，统计分数
                      selfplan.imagenode.src="http://wuwenfu.cn/wp-content/themes/yusi1.0/dafeiji/image/myplanebaozha.gif";
